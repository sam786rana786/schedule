...
import type { EventType, Question, BookingRules } from '@/types/eventType';
    ...
    try {
      ...
      if (existingEventType) {
        formData.value = {
          ...
          booking_rules: existingEventType.booking_rules || formData.value.booking_rules
        };
      } else {
...
const handleSubmit = async () => {
  try {
    ...
    if (isEditing.value) {
      ...
      notificationStore.showNotification('success', 'Event type created successfully');
    }
    ...
    <div class="px-4 py-5 sm:p-6">
      <form @submit.prevent="handleSubmit" class="space-y-6">
        ...
        <div class="border-t border-gray-200 pt-6">
          ...
          <div class="mt-4 space-y-4">
            <div v-for="(question, index) in formData.questions" :key="question.id" class="flex items-start space-x-4 p-4 bg-gray-50 rounded-lg">
              <div class="flex-1">
                <div class="mb-4">
                  <label :for="`question-${index}-label`" class="block text-sm font-medium text-gray-700">Question</label>
                  <input
